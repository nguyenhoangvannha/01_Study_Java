 ...
 */
public class BookStoreFrameV3 extends javax.swing.JFrame {

    /**
     * Creates new form BookStoreFrameV2
     */
    public BookStoreFrameV3() {
        try {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
        } catch (ClassNotFoundException | InstantiationException | IllegalAccessException | UnsupportedLookAndFeelException ex) {
            Logger.getLogger(BookStoreFrameV3.class.getName()).log(Level.SEVERE, null, ex);
        }
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookStoreFrameV3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookStoreFrameV3().setVisible(true);
            }
        });
    }
