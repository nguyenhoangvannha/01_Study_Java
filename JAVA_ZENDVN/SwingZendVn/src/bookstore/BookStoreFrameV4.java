 ...
 */
public class BookStoreFrameV4 extends javax.swing.JFrame {

    /**
     * Creates new form BookStoreFrameV2
     */
    public BookStoreFrameV4() {
        try {
            UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
        } catch (ClassNotFoundException | InstantiationException | IllegalAccessException | UnsupportedLookAndFeelException ex) {
            Logger.getLogger(BookStoreFrameV4.class.getName()).log(Level.SEVERE, null, ex);
        }
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbSortObject.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Price", "Name" }));
        cbSortObject.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbSortObjectItemStateChanged(evt);
            }
        });
        ...
        btSort.setText("Sort");
        btSort.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbSortObject, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(cbSortOption, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btSort, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28))
        );
        ...
        btSuffle.setText("Shuffle");
        btSuffle.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        btSuffle.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSuffleActionPerformed(evt);
            }
        });
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btSuffle, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btSuffle)
                .addContainerGap())
        );

        jPanel7.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));

        btMaxPrice.setText("Max price");
        btMaxPrice.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btMinPrice.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btMaxPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btMinPrice, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tfFindBookResult, javax.swing.GroupLayout.PREFERRED_SIZE, 377, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btListBook, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private String objectSelected = "Price";
    private String optionSelected = "Increase";
    ...
    private void btAutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAutoActionPerformed
        ...
        if(number > (storeObj.getMaxItems() - storeObj.getTotalItems())){
            ...
            for(int i = 0; i < number; i++){
                temp = new Book("Book " + (int)(Math.random()*(1000 - 10 + 1)) + 10, "A12S-"  + (storeObj.getTotalItems() + i) , (int)(Math.random()*(100000 - 10000 + 1)) + 10000 );
                storeObj.addBook(temp);
            }
            JOptionPane.showMessageDialog(null, "Success!");
        }
    ...
    private void btSuffleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuffleActionPerformed
        // TODO add your handling code here:
        if(storeObj.isEmpty() || storeObj == null){
            JOptionPane.showMessageDialog(null, "Store is empty", "Error", JOptionPane.ERROR_MESSAGE);
            btAddBook.requestFocus();
            return;
        }else {
            storeObj.shuffle();
        }
    }//GEN-LAST:event_btSuffleActionPerformed
            ...
            switch(objectSelected){
                case "Price":
                    switch(optionSelected){
                        case "Increase":
                            storeObj.sortPriceIncrease();
                            break;
                        case "Decrease":
                            storeObj.sortPriceDecrease();
                            break;
                    }
                    break;
                case "Name":
                    switch(optionSelected){
                        case "Increase":
                            storeObj.sortNameIncrease();
                            break;
                        case "Decrease":
                            storeObj.sortNameDecrease();
                            break;
                    }
                    break;
            }
    ...
    private void cbSortObjectItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbSortObjectItemStateChanged
        // TODO add your handling code here:
        objectSelected = (String) evt.getItem();
    }//GEN-LAST:event_cbSortObjectItemStateChanged

    private void cbSortOptionItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbSortOptionItemStateChanged
        // TODO add your handling code here:
        optionSelected = (String) evt.getItem();
    ...
    private void btMinPriceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btMinPriceActionPerformed
        ...
        if(storeObj == null || storeObj.isEmpty()){
            ...
            Book tmp = storeObj.minPrice();
            taListBook.setText(tmp.toString());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookStoreFrameV4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookStoreFrameV4().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btSuffle;
    private javax.swing.JComboBox<String> cbSortObject;
